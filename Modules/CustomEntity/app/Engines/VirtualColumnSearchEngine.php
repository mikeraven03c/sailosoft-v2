...
namespace Modules\CustomEntity\Engines;
...
class VirtualColumnSearchEngine extends Engine
{
    /**
    ...
    protected function searchModels(Builder $builder)
    {
        ...
        $handle = $this->ensureSoftDeletesAreHandled($builder, $query);

        $models = $handle->get()->values();
